                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="contact" id="contact" value="<?= set_value('contact', $user->contact) ?>">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="status">Status</label>
                        <input type="text" class="form-control" name="status" id="status" value="<?= set_value('status', $user->status) ?>">
